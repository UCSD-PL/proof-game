...
class UserInfosControllerTest < ActionController::TestCase
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post :create, user_info: { current_puzzle: @user_info.current_puzzle, max_puzzle: @user_info.max_puzzle, username: @user_info.username }
    end
  ...
  test "should update user_info" do
    put :update, id: @user_info, user_info: { current_puzzle: @user_info.current_puzzle, max_puzzle: @user_info.max_puzzle, username: @user_info.username }
    assert_redirected_to user_info_path(assigns(:user_info))
  end
